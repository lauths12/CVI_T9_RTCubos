...
// Ray Tracing Varios Cubos Con 45°
...
// Ray Tracing Varios Cubos Sin 45°
...
//     auto material1 = make_shared<dielectric>(1.5);
//     shared_ptr<hittable> box1 = box(point3(-0.75, 0.0, -0.75), point3(0.75, 1.5, 0.75), material1);
//     world.add(box1);
    
//     auto material2 = make_shared<lambertian>(color(0.4, 0.2, 0.1));
//     shared_ptr<hittable> box2 = box(point3(-4.75, 0.0, -0.75), point3(-3.25, 1.5, 0.75), material2);
//     world.add(box2);
    
//     auto material3 = make_shared<metal>(color(0.7, 0.6, 0.5), 0.0);
//     shared_ptr<hittable> box3 = box(point3(3.25, 0.0, -0.75), point3(4.75, 1.5, 0.75), material3);
//     world.add(box3);
